...
public class UserServiceImpl extends AbstractService implements UserService {
	...
	public User doFindByUserName(String username) {
		String hql = "from  User u left join fetch u.department where u.username=:username";
...
//		String[] whereBodies = { "username like :username", "employeeCode like :employeeCode","email like :email", "departmentId = :departmentId"};
		
		String[] whereBodies = { "username like :username", "employeeCode like :employeeCode", "departmentId = :departmentId"};
