...
<!-- tasks -->
<script src="${base}/resources/admin/scripts/yfy/demo.js" type="text/javascript"></script>
</head>
		...
		<div class="row">
			<div class="col-md-12 margin-bottom-10">
				<form id="queryform" class="form-horizontal">
					...
					<label class="control-label col-md-2" for="queryNameZh" >中文名</label>
					<div class="col-md-2">
						<input class="form-control input-small" type="text" size="30" name="nameZh" id="queryNameZh"  placeholder="请输入中文名"  />					
					</div>
			...
			<div class="col-md-12">
				  <table class="lion-datagrids table table-striped table-bordered table-hover" id="sys_demo_tb" data-singleselect="true", data-loadUrl="list.json" data-checkbox="true" data-pageSize="10">
					<thead>
						<tr>
							<th class="table-checkbox" data-field='id' data-checkbox="true">
						 		<input type="checkbox" class="group-checkable" data-set="#sys_demo_tb.checkboxes"  data-sortable="false" />
						 	</th>
							<th data-field='id' data-sortDir="asc" style="width:40px;">
								编码
							</th>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group">
												<input type="text" id="nameZh" name="nameZh" maxlength="100" class="form-control" placeholder="请输入中文名" size="30"/>
											</div>
										</div>
										</div>
									</div>
